// /frontend/src/components/dashboard/TargetsToday.tsx
"use client";

import { Card } from "@/components/ui/Card";
import Link from "next/link";

interface TargetsTodayProps {
    value: number;
    isScanning?: boolean;
}

export default function TargetsToday({ value, isScanning }: TargetsTodayProps) {
    const priority = value > 5 ? "high" : value > 0 ? "medium" : "low";
